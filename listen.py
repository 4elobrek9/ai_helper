...
def ask_ollama(question: str) -> str:
    ...
    try:
        response = requests.post(
            ...
            json={
                "model": "llama3:8b",
                "prompt": f"[INST] Ответь на русском и достаточно понятно (говори от женского рода милой доброй девушки c интересной жизнью, говори МАКСИМАЛЬНО человечно (без имени)) При ответе не стоит здороваться или что-то типо того. вопрос: {question} [/INST]",
                "stream": False,
